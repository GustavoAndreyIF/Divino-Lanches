...
router.get("/Produtos", (req, res) => mainProdutos.listarTodosProdutos(req, res));
router.get("/Produtos/:categoria", (req, res) => mainProdutos.listarProdutosCategoria(req, res));
router.put("/AlterarProdutoEstoque/:id", (req, res) => mainProdutos.alterarQuantidadeEstoque(req, res));
