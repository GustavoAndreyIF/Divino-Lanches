...
class PedidoModel{
    ...
    create_Pedido(id_cliente: number, id: number, id_produto: number, qt_pedido: number, status_pedido: string, callback:queryCallback){
        const query = `INSERT INTO tb_pedidos (id, id_cliente, id_Produto, Qt_Pedido, status_pedido) VALUES (${id}, ${id_cliente}, ${id_produto}, ${qt_pedido}, ${status_pedido})`;
        db.query(query, callback)
    };
