...
export class ProdutoService {
	...
	async getProdutoPorId(id_produto: number): Promise<any> {
		...
		const produto_object = new Produto(produto[0].id_Product, produto[0].nm_Product, produto[0].descricao, produto[0].price_Product, produto[0].qt_Estoque, produto[0].categoria);
